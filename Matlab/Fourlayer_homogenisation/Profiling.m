...
l2=75;
npts=25;
[T1] =Stochastic4(25, 25, 25, 25, x01, p1, p2, p3, p4, MC,1);
[T2] =Stochastic4(25, 25, 25, 25, x02, p1, p2, p3, p4, MC,1);
[T3] =Stochastic4(25, 25, 25, 25, x03, p1, p2, p3, p4, MC,1);
[T4] =Stochastic4(25, 25, 25, 25, x04, p1, p2, p3, p4, MC,1);

fune=@(p) -loglikelihood(T1, [l1, l2], x01, p, 'exact')... 
          -loglikelihood(T2, [l1, l2], x02, p, 'exact')...
          -loglikelihood(T3, [l1, l2], x03, p, 'exact')...
          -loglikelihood(T4, [l1, l2], x04, p, 'exact');
...
funa=@(p) -loglikelihood(T1, [l1, l2], x01, p, 'approx')... 
          ...
          -loglikelihood(T3, [l1, l2], x03, p, 'approx')...
          -loglikelihood(T4, [l1, l2], x04, p, 'approx'); 
