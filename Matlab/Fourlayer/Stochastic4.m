...
function [T] =Stochastic4(l1,l2,l3,l4,x0,p1,p2,p3,p4,MC,varargin)
if nargin==9
rng(varargin{1});
end
%l1 length of first layer
%l2 length of second layer
%l3 length of third layer
%l4 length of fourth layer
%x0 release point
%p1 diffusivity in first layer
%p2 diffusivity in second layer
%p3 diffusivity in third layer
%p4 diffucitity in fourth layer
%MC number of realisations

T=zeros(1,MC);
I1=l1;          %Location of the first interface
I2=l1+l2;       %Location of the second interface
I3=l1+l2+l3;    %Location of the third interface
LL=l1+l2+l3+l4; %Location of the fourth interface
